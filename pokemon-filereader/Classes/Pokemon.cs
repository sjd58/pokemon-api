...
namespace pokemon_filereader.Classes
{
    public class Pokemon
    {
        ...
        // For example, we will use the top constructor when retreiving Pokemon from the database when we do not want to modify any of the properties.
        ...
        public Pokemon (string[] rawData)
        {
            ...
            // If neither type is Fire, just set attack to what we receive from rawData
            else
            {
        ...
        // A constructor to build the Pokemon without modifying any of the information we receive.
        public Pokemon (
            int pokemonNumber, 
            string name, 
            string type1, 
